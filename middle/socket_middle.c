...
void process_pkt(IP_T *ip_t, const struct pcap_pkthdr *pkthdr, const u_char *packet)
{
    ...
    /** 以下三个mac地址需要在试验前手动获取并更改 */
    unsigned char server_mac[] = {0x00, 0x0c, 0x29, 0x0A, 0x79, 0x0A}; // 服务器mac
    unsigned char client_mac[] = {0x00, 0x0c, 0x29, 0x4A, 0x0D, 0x39}; // 客户端mac
    unsigned char middle_mac[] = {0x00, 0x0c, 0x29, 0x4B, 0xF5, 0x92}; // 中间人mac
